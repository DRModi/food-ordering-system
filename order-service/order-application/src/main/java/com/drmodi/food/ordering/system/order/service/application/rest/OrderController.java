package com.drmodi.food.ordering.system.order.service.application.rest;
...
public class OrderController {
    ...
    public ResponseEntity<CreateOrderResponse> createOrder(@RequestBody CreateOrderCommand createOrderCommand){
        log.info("Creating oder for customer: {} at restaurant: {}", createOrderCommand.getCustomerId(),
    ...
    public ResponseEntity<TrackOrderResponse> getOrderByTrackingId(@PathVariable UUID trackingId){
        ...
        log.info("Returning oder status with tracking id: {}", trackOrderResponse.getOrderTrackingId());
