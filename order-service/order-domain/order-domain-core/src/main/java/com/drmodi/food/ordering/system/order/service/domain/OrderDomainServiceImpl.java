...
import com.drmodi.food.ordering.system.domain.exception.DomainException;
...
public class OrderDomainServiceImpl implements OrderDomainService{
    ...
    //currently this method has O(n)^2 complexity since two inner loop running.
    //time complexity can be reduced to liner O(n) by creating hashmap data structure for products list, with additional cost of some space.
